class ReservationsController < ApplicationController
  ...
  def show
    ...
    @stay_days = (@reservation.end - @reservation.start).to_i
  ...
  def update
    @reservation = Reservation.find(params[:id])
    if @reservation.update(params.require(:reservation).permit(:start, :end, :num_of_guests))
  ...
  def reservation_params
    params.require(:reservation).permit(:start, :end,:num_of_guests, :room_id)
  end
end
